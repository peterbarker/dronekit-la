...
const std::map<const uint32_t, const std::string> _subsys_name = {
    ...
    { ERROR_SUBSYSTEM_THRUST_LOSS_CHECK, "THRUST_LOSS_CHECK" },
    { ERROR_SUBSYSTEM_FAILSAFE_SENSORS, "FAILSAFE_SENSORS" },
    { ERROR_SUBSYSTEM_FAILSAFE_LEAK, "FAILSAFE_LEAK" },
    { ERROR_SUBSYSTEM_PILOT_INPUT, "PILOT_INPUT" },
    { ERROR_SUBSYSTEM_FAILSAFE_VIBE, "FAILSAFE_VIBE" },
    { ERROR_SUBSYSTEM_INTERNAL_ERROR, "INTERNAL_ERROR" },
};
