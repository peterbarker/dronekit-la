...
#define ERROR_SUBSYSTEM_FAILSAFE_SENSORS    26
#define ERROR_SUBSYSTEM_FAILSAFE_LEAK       27
#define ERROR_SUBSYSTEM_PILOT_INPUT         28
#define ERROR_SUBSYSTEM_FAILSAFE_VIBE       29
#define ERROR_SUBSYSTEM_INTERNAL_ERROR      30
