...
CFLAGS += $(INCS) $(OPT) $(DEBUG_SYMBOLS) -DGIT_VERSION=\"$(GIT_VERSION)\" $(WARNFLAGS) $(CSTD) $(GCOV)
CXXFLAGS += $(INCS) $(STD) $(OPT) $(DEBUG_SYMBOLS) -DGIT_VERSION=\"$(GIT_VERSION)\" $(STATIC) $(WARNFLAGS) $(GCOV) $(EFFCPP)
